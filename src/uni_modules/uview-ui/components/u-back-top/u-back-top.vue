<template>
  <u-transition mode="fade" :customStyle="backTopStyle" :show="show">
    <view class="u-back-top" :style="[contentStyle]" v-if="!$slots.default && !$slots.$default" @click="backToTop">
      ...
      <text v-if="text" class="u-back-top__text" :style="[textStyle]">{{ text }}</text>
    </view>
    <slot v-else />
  </u-transition>
</template>
...
$u-back-top-background-color: #ffffff !default;
$u-back-top-tips-font-size: 12px !default;
$u-back-to-shadow: 0px 4rpx 16rpx 0rpx rgba(170, 170, 170, 0.2); // 渐变按钮阴影
.u-back-top {
  @include flex;
