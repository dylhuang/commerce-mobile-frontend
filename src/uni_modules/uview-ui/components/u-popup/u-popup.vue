  ...
  <view class="u-popup">
    ...
    <u-transition :show="show" :customStyle="transitionStyle" :mode="position || ''" :duration="duration" @afterEnter="afterEnter" @click="clickHandler">
      <view class="u-popup__content" :style="[contentStyle]" @tap.stop="noop">
        ...
        <slot></slot>
        <view v-if="closeable" @tap.stop="close" class="u-popup__content__close" :class="['u-popup__content__close--' + closeIconPos]" hover-class="u-popup__content__close--hover" hover-stay-time="150">
...
export default {
  ...
  methods: {
    ...
    retryComputedComponentRect(children) {
      // 组件内部需要计算节点的组件
      const names = ['u-calendar-month', 'u-album', 'u-collapse-item', 'u-dropdown', 'u-index-item', 'u-index-list', 'u-line-progress', 'u-list-item', 'u-rate', 'u-read-more', 'u-row', 'u-row-notice', 'u-scroll-list', 'u-skeleton', 'u-slider', 'u-steps-item', 'u-sticky', 'u-subsection', 'u-swipe-action-item', 'u-tabbar', 'u-tabs', 'u-tooltip']
      // 历遍所有的子组件节点
